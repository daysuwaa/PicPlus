...
const SignIn = () => {
  ...
  <Link to="/PicPlus/post">
    <button
      className="bg-indigo-600 hover:bg-blue-700 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline rounded h-11 w-[280px] lg:w-[450px] sm:w-[570px] md:w-[300px]"
      type="button"
